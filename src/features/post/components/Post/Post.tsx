  ...
  <div className={s.wrapperContain}>
    <div className={s.headerBar}>
      <header className={s.header}>
        ...
        <span className={s.nameAccount}>{posts.userName}</span>
      </header>
    ...
    <div className={s.socialSectionWrapper}>
      ...
      <div className={s.infoBlock}>
        <span className={s.author}>{posts.userName}</span>
        <span className={s.description}>{posts.description}</span>
        {/*          <span className={s.moore}> */}
        {/*  moore */}
        {/* </span> */}
      </div>
      <div className={s.comments}>View all comments</div>
      <div className={s.publicationDate}>{posts.datePublication}</div>
    </div>
