        ...
        <header className={s.header}>
                ...
                <div role={'button'} className={s.divBtn}>
                    <div className={s.wrapper}>
                        <div className={s.searchIcon}>
                            <svg aria-label="Поиск" className="_8-yf5 " color="#8e8e8e" fill="#8e8e8e" height="16"
                                 role="img"
            ...
            <div className={s.navigationBar}>
                <div className={s.homeBtn}>
                    <svg aria-label="Главная страница" className="_8-yf5 " color="#262626" fill="#262626" height="24"
                         role="img"
                ...
                <div className={s.newPostBtn}>
                    <svg aria-label="Новая публикация" className="_8-yf5 " color="#262626" fill="#262626" height="24"
                ...
                <div className={s.findPeopleBtn}>
                    <svg aria-label="Найти людей" className="_8-yf5 " color="#262626" fill="#262626" height="24"
                         role="img" viewBox="0 0 24 24" width="24">
                ...
                <div className={s.watsNewsBtn}>
                    <svg aria-label="Что нового" className="_8-yf5 " color="#262626" fill="#262626" height="24"
                         role="img" viewBox="0 0 24 24" width="24">
                        <path
